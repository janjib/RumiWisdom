...
const getAQuoteButtton = document.querySelector(".get-quote-button");
const getAnotherQuoteButtton = document.querySelector(".get-another-quote-button");
const quoteWords = document.querySelector(".quote-words");

getAnotherQuoteButtton.addEventListener("click",()=>{
    const randomNumber = Math.floor(Math.random()*100);
    const chosenQuotes = quotes[randomNumber];
    console.log(chosenQuotes);
    quoteWords.textContent = chosenQuotes;
})
getAQuoteButtton.addEventListener("click",()=>{
    const randomNumber = Math.floor(Math.random()*100);
    const chosenQuotes = quotes[randomNumber];
    console.log(chosenQuotes);
    quoteWords.textContent = chosenQuotes;
